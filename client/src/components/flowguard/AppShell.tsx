...
const navigation = [
  { href: "/workspace", label: "Control room", icon: LayoutDashboard },
  ...
  return <SidebarProvider defaultOpen>
    <Sidebar variant="inset" collapsible="icon" className="border-r border-slate-200/70 bg-[#FBFCFE] dark:border-slate-800 dark:bg-slate-950">
      <SidebarHeader className="p-4 pb-3">
        <Link href="/workspace" className="group flex items-center gap-3 px-1 no-underline">
