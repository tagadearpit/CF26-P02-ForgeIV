  ...
  return <SidebarProvider defaultOpen>
    <Sidebar variant="inset" collapsible="icon" className="border-r border-slate-200/70 bg-[#FBFCFE]">
      ...
      <SidebarFooter className="p-3">
        ...
        {profileOpen && <div className="mt-1 rounded-lg border border-slate-200 bg-white p-1.5 shadow-lg group-data-[collapsible=icon]:hidden"><button onClick={signOut} className="w-full rounded-md px-2 py-1.5 text-left text-xs font-semibold text-rose-700 hover:bg-rose-50">Sign out</button></div>}
      </SidebarFooter>
    </Sidebar>
